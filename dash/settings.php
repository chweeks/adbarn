                 ...
                 <div class="row">
                  <div class="col-lg-12">
                   <section class="row m-l-none m-r-none m-b text-center bg-white panel b-a">
                     <h1 class="text-orange">Settings</h1>
                     <br>
                     <div class="row">
                      <form class="form-inline">
                        <div class="col-lg-offset-2 col-lg-4">
                         <div class="form-group">
                           <label for="exampleInputName2">Contact Name (optional)</label>
                     ...
                     <div class="row">
                      ...
                      <div class="col-lg-4">
                        <div class="form-group">
                          <label for="currency">Performance Report Currency</label>
                       ...
                       <div class="col-lg-4">
                         <div class="form-group">
                           ...
                           <select class="form-control" id="country">
                             ...
                             <option>Bank Transfer (UK Only)</option>
