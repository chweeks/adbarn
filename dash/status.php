...
<body class="container">
                     ...
                     <section class="row m-b-md"></section>
                      <div class="row">
                         ...
                         <section class="row m-l-none m-r-none m-b text-center bg-white panel b-a">
                           <h1 class="text-orange">Status</h1>
                           <div class="col-lg-offset-1 col-lg-10">
                            <div class="alert alert-success" role="alert">
                              All Good! You've got no violations!
                            </div>
                            <div class="alert alert-warning" role="alert">
                              Site Suspended! Ad serving temporarily suspended until site is cleared
                              <br>
                              <a class="contact" data-toggle="modal" href="#siteSuspension">Contact us for re-evaluation</a>
                            </div>
                            <div class="modal fade bs-example-modal-lg" id="siteSuspension" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
                              <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                  <div class="alert alert-warning" role="alert">
                                    Site suspension reason: Relevant reason for suspending site
                                  </div>
                                  <p>Please use the below form to send as much supporting information as possible so that we can endeavour to reinstate
                                    your account</p>
                                  <form>
                                    <div class="form-group">
                                      <div class="row">
                                        <div class="col-lg-offset-1 col-lg-10">
                                          <textarea rows="10" placeholder="Please give as much supporting information as possible to assist your case"></textarea>
                                        </div>
                                      </div>
                                    </div>
                                    <div class="row">
                            ...
                            <div class="alert alert-danger" role="alert">
                              Site Banned! Ad serving will not be renewed, no action possible
                            </div>
                            <div class="alert alert-danger" role="alert">
                              Account Suspended! Ad serving is cancelled for all domains. You can still withdraw funds.
                              <br>
                              <a class="contact" data-toggle="modal" href="#accountSuspension">Contact us for re-evaulation</a>
                            </div>
                            <div class="modal fade bs-example-modal-lg" id="accountSuspension" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
                              <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                  <div class="alert alert-danger" role="alert">
                                    Account suspension reason: Relevant reason for suspending account
                                  </div>
                                  <p>Please use the below form to send as much supporting information as possible so that we can endeavour to reinstate
                                    your account</p>
                                  <form>
  ...
  <script src="js/boostrap-lightbox.js"></script>
  <!-- App -->
