          ...
          <div class="col-md-12">
            ...
            <div class="well well-md">
              ...
              <div class="col-md-4 tc about-features">
                ...
                <h4>It works</h4>
                <p>Optimized for context, Geo and platform. <br>
                  Advanced ad formats</p>
              </div>
              <div class="col-md-4 tc about-features">
                <i class="fa fa-money"></i>
                <h4>It Pays</h4>
                <p>Automated payment solutions.<br>
                  Earn more as an affiliate. <br>
                </p>
              </div>
              <div class="col-md-4 tc about-features">
                <i class="fa fa-wrench"></i>
                <h4>It's Simple</h4>
                <p>15 Second registration. <br>
                  No invoicing drama.
                  </p>
              </div>
