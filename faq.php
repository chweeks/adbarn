      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2 class="tc">FAQ</h2>
            <hr>
            <ul class="nav nav-pills faq-nav">
              <li class="active"><a href="#home" data-toggle="tab">General questions</a></li>
              <li><a href="#profile" data-toggle="tab">Technical issues</a></li>
              <li><a href="#messages" data-toggle="tab">Appearance issues</a></li>
